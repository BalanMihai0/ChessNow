package fontys.sem3.chess.configuration.exceptionhandler;
...
public class RestCustomExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ProblemDetail handleUnknownRuntimeError(final AccessDeniedException error) {
        log.error("Acces denied error occurred.", error);
